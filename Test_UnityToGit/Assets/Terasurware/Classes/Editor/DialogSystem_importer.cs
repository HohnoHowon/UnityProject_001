...
public class DialogSystem_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/00.Scenes/DialogSystem.xlsx";
	private static readonly string exportPath = "Assets/00.Scenes/DialogSystem.asset";
